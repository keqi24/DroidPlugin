...
package android.exmaple.plugin.hook.handle;
...
import android.exmaple.plugin.helper.compat.IPackageDataObserverCompat;
import android.exmaple.plugin.helper.compat.ParceledListSliceCompat;
import android.exmaple.plugin.hook.BaseHookHandle;
import android.exmaple.plugin.hook.HookedMethodHandler;
        ...
        protected boolean beforeInvoke(Object receiver, Method method, Object[] args) throws Throwable {
            ...
            if (args != null) {
                ...
                if (args.length > index0) {
                    ...
                    //here replace the plugin package name with host package name, so the plugin will own the same UID as host
