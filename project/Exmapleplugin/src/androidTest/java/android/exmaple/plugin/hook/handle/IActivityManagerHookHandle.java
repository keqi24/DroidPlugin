...
import android.exmaple.plugin.core.Env;
import android.exmaple.plugin.core.PluginProcessManager;
import android.exmaple.plugin.helper.Log;
import android.exmaple.plugin.helper.compat.ActivityManagerCompat;
...
import android.exmaple.plugin.stub.ShortcutProxyActivity;
            ...
            if (args != null && args.length > 1 && intentOfArgIndex >= 0) {
                ...
                if (activityInfo != null && isPackagePlugin(activityInfo.packageName)) {
                    ...
                    if (component != null) {
                        ...
                        try {
                            ClassLoader pluginClassLoader = PluginProcessManager.getPluginClassLoader(
